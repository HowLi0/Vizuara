...
impl InteractiveTool for ZoomTool {
    fn handle_mouse_event(
        ...
        match event {
            ...
            SimpleMouseEvent::ButtonPress { button, position } if self.button == Some(*button) => {
    ...
    fn handle_keyboard_event(
        ...
        match event {
            SimpleKeyboardEvent::KeyPress { key } => match key.as_str() {
                "+" | "=" => {
...
mod tests {
    ...
    fn test_pan_tool() {
        ...
        assert!(pan_tool
            .handle_mouse_event(&press_event, &mut viewport)
            .unwrap());
        ...
        assert!(pan_tool
            .handle_mouse_event(&move_event, &mut viewport)
            .unwrap());
    ...
    fn test_zoom_tool() {
        ...
        assert!(zoom_tool
            .handle_mouse_event(&scroll_event, &mut viewport)
            .unwrap());
    ...
    fn test_select_tool() {
        ...
        assert!(select_tool
            ...
            .unwrap());
        assert!(select_tool
            .handle_mouse_event(&release_event, &mut viewport)
            .unwrap());
    ...
    fn test_tool_manager() {
        ...
        assert!(manager
            .handle_keyboard_event(&key_event, &mut viewport)
            .unwrap());
