use crate::{
    ColorPalette, ComponentTheme, ComponentType, Theme, ThemeProperty, ThemeResult, ThemeValue,
};
...
impl ThemeBuilder {
    ...
    pub fn from_preset(preset_name: &str) -> Option<Self> {
        crate::ThemePresets::get_preset(preset_name).map(Self::from_theme)
    }
    ...
    pub fn primary_color(mut self, color: Color) -> Self {
        self.theme
            .set_global(ThemeProperty::PrimaryColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn secondary_color(mut self, color: Color) -> Self {
        self.theme
            .set_global(ThemeProperty::SecondaryColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn accent_color(mut self, color: Color) -> Self {
        self.theme
            .set_global(ThemeProperty::AccentColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn background_color(mut self, color: Color) -> Self {
        self.theme
            .set_global(ThemeProperty::BackgroundColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn text_color(mut self, color: Color) -> Self {
        self.theme
            .set_global(ThemeProperty::TextColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn border_color(mut self, color: Color) -> Self {
        self.theme
            .set_global(ThemeProperty::BorderColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn grid_color(mut self, color: Color) -> Self {
        self.theme
            .set_global(ThemeProperty::GridColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn font_size(mut self, size: f32) -> Self {
        self.theme
            .set_global(ThemeProperty::FontSize, ThemeValue::Number(size));
        self
    }
    ...
    pub fn line_width(mut self, width: f32) -> Self {
        self.theme
            .set_global(ThemeProperty::LineWidth, ThemeValue::Number(width));
        self
    }
    ...
    pub fn point_size(mut self, size: f32) -> Self {
        self.theme
            .set_global(ThemeProperty::PointSize, ThemeValue::Number(size));
        self
    }

    /// 设置透明度
    pub fn opacity(mut self, opacity: f32) -> Self {
        self.theme.set_global(
            ThemeProperty::Opacity,
            ThemeValue::Number(opacity.clamp(0.0, 1.0)),
        );
        self
    }
    ...
    pub fn palette(mut self, palette: ColorPalette) -> Self {
        ...
        self.theme
            .set_global(ThemeProperty::TextColor, ThemeValue::Color(palette.text));

        // 存储系列颜色
        for (i, color) in palette.series.iter().enumerate() {
            self.theme
                .set_custom(format!("series_color_{}", i), ThemeValue::Color(*color));
        }

        self.theme
            .set_custom("palette_name", ThemeValue::String(palette.name));
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        self.theme
            .add_component(ComponentType::ScatterPlot, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::LinePlot, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::BarPlot, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::Histogram, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::Heatmap, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::BoxPlot, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::Scatter3D, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::Surface3D, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::Axis, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::Grid, component_theme);
        self
    }
        ...
        F: FnOnce(ComponentThemeBuilder) -> ComponentThemeBuilder,
    {
        ...
        let component_theme = config(builder).build();
        self.theme
            .add_component(ComponentType::Legend, component_theme);
        self
    }
...
impl ComponentThemeBuilder {
    ...
    pub fn primary_color(mut self, color: Color) -> Self {
        self.component_theme
            .set_property(ThemeProperty::PrimaryColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn secondary_color(mut self, color: Color) -> Self {
        self.component_theme
            .set_property(ThemeProperty::SecondaryColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn accent_color(mut self, color: Color) -> Self {
        self.component_theme
            .set_property(ThemeProperty::AccentColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn border_color(mut self, color: Color) -> Self {
        self.component_theme
            .set_property(ThemeProperty::BorderColor, ThemeValue::Color(color));
        self
    }
    ...
    pub fn line_width(mut self, width: f32) -> Self {
        self.component_theme
            .set_property(ThemeProperty::LineWidth, ThemeValue::Number(width));
        self
    }
    ...
    pub fn point_size(mut self, size: f32) -> Self {
        self.component_theme
            .set_property(ThemeProperty::PointSize, ThemeValue::Number(size));
        self
    }
    ...
    pub fn font_size(mut self, size: f32) -> Self {
        self.component_theme
            .set_property(ThemeProperty::FontSize, ThemeValue::Number(size));
        self
    }

    /// 设置透明度
    pub fn opacity(mut self, opacity: f32) -> Self {
        self.component_theme.set_property(
            ThemeProperty::Opacity,
            ThemeValue::Number(opacity.clamp(0.0, 1.0)),
        );
        self
    ...
    pub fn border_radius(mut self, radius: f32) -> Self {
        self.component_theme
            .set_property(ThemeProperty::BorderRadius, ThemeValue::Number(radius));
        self
    }

    /// 设置悬停状态的颜色
    pub fn hover_color(mut self, color: Color) -> Self {
        self.component_theme.set_state_property(
            "hover",
            ThemeProperty::PrimaryColor,
...
mod tests {
    ...
    fn test_component_theme_builder() {
        ...
        assert_eq!(
            scatter_theme.get_number(&ThemeProperty::PointSize),
            Some(6.0)
        );
