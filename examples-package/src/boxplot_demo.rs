...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let group_a_scores = vec![
        85.0, 87.0, 89.0, 91.0, 88.0, 86.0, 90.0, 84.0, 92.0, 88.0, 85.0, 89.0, 87.0, 90.0, 86.0,
        83.0, 91.0, 88.0, 89.0, 87.0,
    ];

    let group_b_scores = vec![
        78.0, 82.0, 85.0, 79.0, 83.0, 81.0, 84.0, 77.0, 86.0, 80.0, 79.0, 83.0, 82.0, 85.0, 81.0,
        76.0, 84.0, 82.0, 80.0, 78.0,
    ];

    let group_c_scores = vec![
        92.0, 95.0, 88.0, 94.0, 96.0, 89.0, 93.0, 91.0, 97.0, 90.0, 94.0, 88.0, 92.0, 95.0, 89.0,
        96.0, 93.0, 91.0, 94.0, 87.0,
    ];
