...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let lights = vec![
        ...
        // 环境填充光 - 冷色调
        Light::directional(Vector3::new(0.3, 0.4, 0.7), Color::rgb(0.6, 0.8, 1.0), 1.2),
        // 背光 - 轮廓光
        Light::directional(Vector3::new(0.8, 0.2, 0.6), Color::rgb(1.0, 0.7, 0.9), 0.8),
        // 点光源 - 动态高亮
        Light::point(
...
/// 添加立方体顶点到列表
fn add_cube_vertices(
    vertices: &mut Vec<Vertex3DLit>,
    center: [f32; 3],
    size: f32,
    color: [f32; 3],
) {
